...
======
A template project for building class libraries with Visual Studio 2015, C# 6, NUnit 2, AutoFixtures, and NuGet packaging using the Appveyor build platform.
